...
workers=[]
init_pose=[
	[[-4.0, 14.0, 3.0, 0.0, 0.0, -1.57]],
	[[-4.0, 4.0, 3.0, 0.0, 0.0, 0.0]],
	[[-4.0, -6.0, 3.0, 0.0, 0.0, 0.0]],
	[[-39.0, 9.5, 3.0, 0.0, 0.0, -1.57]]
]
...
#Test evaluator with parameters copied from the master network
...
def train_in_test_environment():
	...
	try:
		...
		saver.save(
			sess,
			"./save/model/trained_in_test_env/master_networks"
		)
		csv_file.close()
...
def main():
	...
	try:
		...
		saver.save(
			sess,
			"./save/model/final/master_networks"
		)
		csv_file.close()
