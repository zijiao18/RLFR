...
init_pose=[[[-4.0,14.0,3.0,0,0,-1.57]],
		...
		#[[11.0,14.0,3.0,0,0,0]],
		#[[19.0,4.0,3.0,0,0,0]],
		[[-39.0,9.5,3.0,0,0,-1.57]]]#-39.0,9.5,3.0,0,0,-1.57

goals=[[[8.0,10.0,3.0]],#8,10.0,3.0
	[[4.0,-4.0,3.0]],
	[[4.0,-13.0,3.0]],
	#[[17.0,10.0,0.0]],
	#[[13.5,0.0,0.0]],
	[[-7.5,-11.5,3.0]]]#-11.0,-9.5,3.0
...
def test_for_evaluator_save():
	...
	saver.restore(sess,"./save/model/a3c_trained/succ6/master_networks")
...
def train_in_test_environment():
	...
	try:
		...
		saver.save(sess,"./save/model/testenv_trained/master_networks")
		csv_file.close()
...
def main():
	...
	try:
		...
		for worker in workers:
			worker.terminate()
			print("joined",worker.name)
		saver.save(sess,"./save/model/a3c_trained_final/master_networks")
		csv_file.close()
