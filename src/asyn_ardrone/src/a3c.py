...
def test_for_evaluator_save():
	...
	saver.restore(
		sess,
		"./save/model/a3c_trained/succ6/master_networks"
	)
...
def train_in_test_environment():
	...
	try:
		...
		saver.save(
			sess,
			"./save/model/testenv_trained/master_networks"
		)
		csv_file.close()
...
def main():
	...
	try:
		...
		saver.save(
			sess,
			"./save/model/a3c_trained_final/master_networks"
		)
		csv_file.close()
